	...
	<script type="text/javascript">
		...
		function save() {
	            ...
	            if(!isValidate){
	                ...
	                jp.loading();
	                jp.post("${ctx}/tp/road/area/save",$('#inputForm').serialize(),function(data){
	                    if(data.success){
		   ...
		   <tbody>
				<tr>
					...
					<td class="width-35">
						...
						title="父级编号" url="/tp/road/area/treeData" extId="${area.id}" cssClass="form-control " allowClear="true"/>
					</td>
